...
export function StartScreen({ onStart }: StartScreenProps) {
  return (
    <div className="flex min-h-dvh flex-col items-center justify-center gap-10 px-6 py-12 landscape:h-full landscape:min-h-0 landscape:overflow-y-auto landscape:overscroll-contain landscape:py-6">
      {/* 타이틀 섹션 */}
      <div className="text-center">
        ...
        <p className="mt-2 text-sm font-medium text-violet-300/80">五行召喚</p>
